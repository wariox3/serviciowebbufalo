...
$consulta = "
SELECT IdManifiesto, OrdDespacho, Tipo, FhExpedicion, FhCumplidos, IdVehiculo, IdConductor, IdRuta, IdCiudadOrigen, IdCiudadDestino, Estado,
...
ExportadoContabilidad FROM despachos ";
...
codigo_vehiculo_fk, codigo_ruta_fk, fecha_registro, fecha_salida, cantidad, unidades, peso_real, peso_volumen, vr_declara, vr_flete_pago, vr_anticipo, 
...
while ($columna = mysqli_fetch_array($resultado)) {
    ...
    '" . $columna['IdVehiculo'] . "', '" . $columna['IdRuta'] . "','". $columna['FhExpedicion'] . "','". $columna['FhExpedicion'] . "',". $columna['Remesas'] . ",
